...
<section class="py-16 bg-black">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="mx-auto" style="max-width: 1505px;">
            <div class="bg-white py-8 rounded-xl shadow-xl overflow-hidden">
                <div class="overflow-hidden">
                    <div class="flex animate-scroll">
                        <!-- First set of logos -->
                        <div class="flex items-center gap-16 mx-12">
                            <img src="images/logos/toyota.png" alt="Toyota" class="h-12 md:h-16 object-contain">
                            <img src="images/logos/mazda.png" alt="Mazda" class="h-12 md:h-16 object-contain">
                            ...
                            <img src="images/logos/homda.png" alt="Honda" class="h-12 md:h-16 object-contain">
                            <img src="images/logos/ford.png" alt="Ford" class="h-12 md:h-16 object-contain">
                            <img src="images/logos/gwm.png" alt="GWM" class="h-12 md:h-16 object-contain">
                        </div>
